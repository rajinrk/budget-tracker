...
import { AppBar, Toolbar, Typography, Button, Box, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
import { Link } from 'react-router-dom';
import { AuthHeader } from '../auth-header';
import { useDispatch, useSelector } from 'react-redux';
import { store } from '../../services/redux/store';
import { fetchCategorySpendingRequest, logout, setSelectedMonth } from '../../services/redux/slices';
